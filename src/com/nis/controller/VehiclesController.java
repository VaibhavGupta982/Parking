...
public class VehiclesController {
	...
	public static boolean newRecord(Vehicle t)
	{try{
	 String query="insert into vehicle(username,currentdate,currenttime,vehiclenumber,mobileno)values("+t.getUsername()+"','"+t.getDate()+"','"+t.getTime()+"','"+t.getVehicleno()+"','"+t.getMobile()+"')";
	 System.out.println(query);
	 boolean statu=DbHelper.executeUpdate(query);
	 return(statu);
