...
out.println("<body class='fix-header fix-sidebar card-no-border'>");
	...
	//	out.println("                            <img src='admin/assets/images/logo-light-icon.png' alt='homepage' class='light-logo' />");
		...
		out.println("<li><a class='has-arrow waves-effect waves-dark' href='EmployeeView' target='mw'><i class='mdi mdi-bullseye'></i><span class='hide-menu'>Add Employee</span></a></li>");
		out.println("<li><a class='has-arrow waves-effect waves-dark' href='DisplayAllEmployees' target='mw'><i class='mdi mdi-bullseye'></i><span class='hide-menu'>Display All</span></a></li>");
		out.println("<li><a class='has-arrow waves-effect waves-dark' href='SearchEmployeeById' target='mw'><i class='mdi mdi-bullseye'></i><span class='hide-menu'>Search</span></a></li>");
	//	out.println("<li><a class='has-arrow waves-effect waves-dark' href='FloorView' target='mw'><i class='mdi mdi-bullseye'></i><span class='hide-menu'>Add Floor</span></a></li>");
