...
public class AdminLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form class='form-horizontal form-material' action='CheckAdminLogin' method='post'>");
		out.println(" <h3 class='box-title m-b-20'><center>Administrative Sign In</center></h3> <center><img src='logo.png' class='img'></center>");
		out.println("                        <div class='form-group '>");
		out.println("                            <div class='col-xs-12'>");
		out.println("                                <input class='form-control' type='text' required='' name='id' placeholder='Admin ID'> </div>");
		out.println("                        </div>");
		out.println("                        <div class='form-group'>");
		out.println("                            <div class='col-xs-12'>");
		...
		out.println("                            <div class='col-xs-12'>");
		out.println("                                <button class='btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light'  type='submit'>Log In</button>");
		out.println("                            </div>");
		out.println("                        </div>");
