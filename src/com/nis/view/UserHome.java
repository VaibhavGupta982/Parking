...
public class UserHome extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HttpSession ses=request.getSession();
				try{
				String nv="<center><i>User Id:"+ses.getValue("USERID").toString()+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+ses.getValue("USERNAME").toString()+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+ses.getValue("LTIME")+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='/Parking/images/"+ses.getValue("APICTURE")+"' width=30 height=30></i></center>";
				out.println(nv);
...
out.println("<body class='fix-header fix-sidebar card-no-border'>");
	...
	//	out.println("                            <img src='admin/assets/images/logo-light-icon.png' alt='homepage' class='light-logo' />");
		...
		out.println("<li><a class='has-arrow waves-effect waves-dark' href='UserEdit' target='mw'><i class='mdi mdi-bullseye'></i><span class='hide-menu'>Edit User Data</span></a></li>");
		out.println("<li><a class='has-arrow waves-effect waves-dark' href='UserData' target='mw'><i class='mdi mdi-bullseye'></i><span class='hide-menu'>Generate Tikit</span></a></li>");
		//out.println("<li><a class='has-arrow waves-effect waves-dark' href='QRCode' target='mw'><i class='mdi mdi-bullseye'></i><span class='hide-menu'>QR Code</span></a></li>");
		out.println("<li><a class='has-arrow waves-effect waves-dark' href='UserLogout' target='_parent'><i class='mdi mdi-bullseye'></i><span class='hide-menu'>Logout</span></a></li>");
		...
		//HttpSession ses=request.getSession();
		//try{
		//String nv="<center><i>Admin Id:"+ses.getValue("ADMINID").toString()+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+ses.getValue("ADMINNAME").toString()+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"+ses.getValue("LTIME")+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src='/Parking/images/"+ses.getValue("APICTURE")+"' width=30 height=30></i></center>";
		//out.println(nv);
		//Prepare Session Navigation
		//}catch(Exception e)
		//{
