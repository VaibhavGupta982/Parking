...
public class EmployeeLogin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<form class='form-horizontal form-material' action='CheckEmployeesLogin' method='post'>");
		out.println(" <h3 class='box-title m-b-20'><center>Employee Sign In</center></h3> <center><img src='logo.png' class='img'></center>");
		
		out.println("                        <div class='form-group '>");
		out.println("                            <div class='col-xs-12'>");
		out.println("                                <input class='form-control' type='text' required='' name='id' placeholder='Employee ID'> </div>");
		out.println("                        </div>");
		out.println("                        <div class='form-group'>");
		out.println("                            <div class='col-xs-12'>");
		...
		out.println("                            <div class='col-xs-12'>");
		out.println("                                <input class='btn btn-info'  type='submit' value='Log In' name='Btn'>");
		out.println("                            </div>");
		out.println("                        </div>");
