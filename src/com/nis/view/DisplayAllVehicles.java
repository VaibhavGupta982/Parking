...
public class DisplayAllVehicles extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(rs.next())
	    { 
	    out.println("<center><table class='table table-bordered' style='width:75%; font-size:12px;' ><h2><b><i>List of Vehicles</i></b></h2>");
	   out.println("<tr><td>Employeeid</td><td>Vehicleid</td><td>Referrenceid</td><td>floorid</td><td>Mobileno</td><td>Currentdate<br>Currenttime</td><td>Time</td><td>Amount</td><td>status</td><td>Update</tr>");
	    do{
	    out.println("<tr><td>"+rs.getString(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(8)+"</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5)+"<br>"+rs.getString(6)+"</td><td>"+rs.getString(8)+"</td><td>"+rs.getString(7)+"</td><td>"+rs.getString(9)+"</td><td>"+"<a class='btn btn-info btn-xs' href=EditDeleteDisplayVehiclesByID?vid="+rs.getString(2)+">Edit/Delete</a></td></tr>");	
