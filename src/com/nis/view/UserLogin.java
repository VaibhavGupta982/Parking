...
PrintWriter out=response.getWriter();
		...
		out.println("        <div class='login-register' style='background-image:url(admin/assets/images/background/vaibha.png);'>");
		out.println("            <div class='login-box card'>");
		out.println("  <div class='card-body'>");
		out.println("<form class='form-horizontal form-material' action='CheckUserLogin' method='post'>");
		out.println(" <h3 class='box-title m-b-20'><center>User Sign In</center></h3> <center><img src='logo.png' class='img'></center>");
		out.println("                        <div class='form-group '>");
		out.println("                            <div class='col-xs-12'>");
		out.println("                                <input class='form-control' type='text' required='' name='id' placeholder='User ID'> </div>");
		out.println("                        </div>");
		out.println("                        <div class='form-group'>");
		out.println("                            <div class='col-xs-12'>");
		out.println("                                <input class='form-control' type='password' required='' name='password' placeholder='Password'> </div>");
		out.println("                        </div>");
		out.println("                        <div class='form-group row'>");
		out.println("                        </div>");
		out.println("                        <div class='form-group text-center m-t-20'>");
		out.println("                            <div class='col-xs-12'>");
		out.println("                                <button class='btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light'  type='submit'>Log In</button><br><br><br>Click Here for <a href='UserView' class='btn btn-warning btn-xs'>Signup</a>");
		out.println("                            </div>");
		out.println("                        </div>");
