...
public class DisplayAllEmployees extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    if(rs.next())
	    { 
	    out.println("<center><table class='table table-bordered' style='width:75%; font-size:12px;' ><h2><b><i>List of Employees</i></b></h2>");
	    ...
	    do{
	    out.println("<tr><td>"+rs.getString(2)+"<br><img class='img-thumbnail' src='/Parking/images/"+rs.getString(12)+"' width=25 height=25><br>"+rs.getString(1)+"</td><td>"+rs.getString(4)+"<br>"+rs.getString(3)+"</td><td>"+rs.getString(5)+"<br>"+rs.getString(14)+","+rs.getString(13)+"</td><td>"+rs.getString(10)+"<br>"+rs.getString(11)+"</td><td>"+rs.getString(8)+"<br>"+rs.getString(9)+"</td><td><a href=EditDeleteDisplayByID?eid="+rs.getString(1)+" class='btn btn-info btn-xs'>Edit/Delete</a></td></tr>");	
