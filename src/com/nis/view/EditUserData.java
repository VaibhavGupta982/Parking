...
PrintWriter out=response.getWriter();
		...
		out.println("    <title>UserEdit</title>");
		...
		out.println("<form class='form-horizontal form-material' action='' method='post'>");
		out.println(" <h3 class='box-title m-b-20'><center>User Edit</center></h3> <center><img src='logo.png' class='img'></center>");
		...
		out.println("                        <div class='form-group'>");
		out.println("                            <div class='col-xs-12'>");
		out.println("                                <input class='form-control' type='text' required='' name='vno' placeholder='Vehical Number'> </div>");
		out.println("                        </div>");
		out.println("                        <div class='form-group row'>");
		out.println("                        </div>");
		out.println("                        <div class='form-group text-center m-t-20'>");
		out.println("                            <div class='col-xs-12'>");
		out.println("                                <button class='btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light'  type='submit'>GO</button>");
		out.println("                            </div>");
		out.println("                        </div>");
